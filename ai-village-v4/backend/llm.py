...
TUNNEL_HEADERS = {
    "User-Agent": "AI-Village-V4/1.0",
    "Accept": "application/json"
}

def ask(prompt: str, officer_id: str = "default") -> str:
    """
    Send a prompt to Ollama and get a response.
    
    Args:
        prompt: The prompt to send
        officer_id: Officer identifier to select the appropriate model
...
def ask_with_role(role: str, task: str, officer_id: str = "default") -> str:
    """
